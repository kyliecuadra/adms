        ...
        <div class="layout-container">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card px-4 py-4">
                            <!-- REQUESTED DOCUMENTS TABLE START -->
                            <table id="requestedDocumentsTable" class="mr-2 table table-hover table-bordered table-responsive">
                <thead>
                  <tr>
                    <th class="fw-bolder">Document Type</th></th>
                    <th class="fw-bolder">Document Name</th>
                    <th class="fw-bolder">Requestor</th>
                    <th class="fw-bolder">Action</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td>Document Type 1</td>
                    <td>Document Name</td>
                    <td>Requestor</td>
                    <td><button class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#">Approve</button>
                    <button class="btn btn-danger text-white" data-bs-toggle="modal" data-bs-target="#" style="background-color: #ff3e1d !important; border-color: #ff3e1d !important;">Reject</button></td>
                  </tr>
                </tbody>
              </table>

                            <!-- REQUESTED DOCUMENTS TABLE END -->
                        </div>
                    </div>
                    <!-- / Layout page -->
                </div>
            ...
            <script>
                $(document).ready(function() {
                    $('#requestedDocumentsTable').DataTable({
                        "paging": true,
                        "searching": true,
                        "ordering": true,
                        "info": true,
