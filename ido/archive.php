        ...
        <div class="layout-container">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card px-4 py-4">
                            <!-- ARCHIVED DOCUMENTS TABLE START -->
                            <table id="archivedDocumentsTable" class="mr-2 table table-hover table-bordered table-responsive">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Document Name</td>
                                        <td class="d-flex align-items-center"><a href=""><i class='text-danger fs-3 bx bx-trash'></i></a>
                                            <a href=""><i class='text-warning fs-3 fa-regular fa-eye'></i></a></i>
                                    </tr>
                                    <tr>
                                        <td>Document Type 2</td>
                                        <td>Document Name</td>
                                        <td class="d-flex align-items-center"><a href=""><i class='text-danger fs-3 bx bx-trash'></i></a>
                                            <a href=""><i class='text-warning fs-3 fa-regular fa-eye'></i></a></i>
                                    </tr>
                                    <tr>
                                        <td>Document Type 3</td>
                                        <td>Document Name</td>
                                        <td class="d-flex align-items-center"><a href=""><i class='text-danger fs-3 bx bx-trash'></i></a>
                                            <a href=""><i class='text-warning fs-3 fa-regular fa-eye'></i></a></i>
                                    </tr>
            ...
            <script>
                $(document).ready(function() {
                    $('#archivedDocumentsTable').DataTable({
                        "paging": true,
                        "searching": true,
                        "ordering": true,
                        "info": true,
