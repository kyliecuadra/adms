...
<head>
    ...
    <title>Requested Documents - <?php echo htmlspecialchars($campusName, ENT_QUOTES, 'UTF-8'); ?></title>
    <!-- Favicon -->
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-muted"
                                            onclick="onclick="openUpdateModal(<?php echo $_SESSION['id']; ?>)"" style="cursor: pointer;">
            ...
            render: function(data, type, row) {
                return `
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                        <a href="documents.php?campus=${encodeURIComponent(row.campus)}&college=${encodeURIComponent(row.college)}" class="text-success fs-3 bx bx-right-arrow-circle"></a>
                        </div>
                    </div>
                `;
            }
