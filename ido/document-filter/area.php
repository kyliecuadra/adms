...
<head>
    ...
    <meta name="viewport"
        ...
        <title>Filter Configuration - <?php echo htmlspecialchars($collegeName, ENT_QUOTES, 'UTF-8'); ?></title>
    <!-- Favicon -->
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card px-4 py-4">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <button class="btn" data-bs-toggle="modal" data-bs-target="#addAreaModal">Add
                                    Area</button>
                            </div>
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="area" id="area"
                                        aria-describedby="helpId" placeholder="Area Name" autofocus />
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="submit" id="submitArea" class="btn btn-primary">Add Area</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="deleteArea" class="btn btn-danger">Delete</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <script>
                ...
                $(document).ready(function () {
                    $('#areaTable').DataTable({
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <span>${row.area}</span>
                            <div>
                                <a href="#" class="text-danger fs-3 bx bx-trash" data-id="${row.area}" onclick="deleteArea('${row.area}')"></a>
                                <a href="parameter.php?campus=${encodeURIComponent(row.campus)}&college=${encodeURIComponent(row.college)}&area=${encodeURIComponent(row.area)}" class="text-success fs-3 bx bx-right-arrow-circle"></a>
                            </div>
                        </div>
                    `;
                            }
                ...
                $(document).ready(function () {
                    $('#submitArea').click(function () {
                        ...
                        // Simple validation
                        if (areaName.trim() === '') {
                            toastr.error('Please enter an area name.');
                            return;
                        }
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response == "success") {
                                    ...
                                    $('#area').val(''); // Clear input field
                                    $('#addAreaModal').modal('hide');
                                } else {
                                    console.log(response);
                                    toastr.error('Area is already existing');
                                    $('#area').val(''); // Clear input field
                                }
                ...
                function deleteArea(area) {
                    ...
                    $('#deleteArea').off('click').on('click', function (event) {
                        console.log(college);
