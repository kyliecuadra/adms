        ...
        $('#areaTable').DataTable({
          ...
          columns: [{
            ...
            render: function(data, type, row) {
              return `
                    <div class="d-flex justify-content-between" onclick="location.href='parameters.php?campus=<?php echo urlencode($campusName); ?>&college=<?php echo urlencode($collegeName); ?>&program=<?php echo urlencode($programName); ?>&area=${encodeURIComponent(row.area)}'" style="cursor: pointer;">
                    <span>${row.area}</span>
                    </div>
                `;
            }
