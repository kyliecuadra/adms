...
<head>
  ...
  <title>Documents - <?php echo htmlspecialchars($programName, ENT_QUOTES, 'UTF-8'); ?></title>
  <!-- Favicon -->
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="card px-4 py-4">
              <div class="d-flex justify-content-between mb-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb fs-4">
                    ...
                    <li class="breadcrumb-item">
                      <a href="#" onclick="window.history.back(); return false;"><?php echo $parameterName; ?></a>
                    </li>
              ...
              <table id="qualityTable" class="mr-2 table table-hover table-bordered table-responsive">
                <thead>
                  <th><strong>Quality Name</strong></th>
                </thead>
                <tbody>
                  <tr onclick="location.href='documents.php?campus=<?php echo urlencode($campusName); ?>&college=<?php echo urlencode($collegeName); ?>&program=<?php echo urlencode($programName); ?>&area=<?php echo urlencode($areaName); ?>&parameter=<?php echo urlencode($parameterName); ?>&quality=System - Inputs and Processes'" style="cursor: pointer;">
                    <td>System - Inputs and Processes</td>
                  </tr>
                  <tr onclick="location.href='documents.php?campus=<?php echo urlencode($campusName); ?>&college=<?php echo urlencode($collegeName); ?>&program=<?php echo urlencode($programName); ?>&area=<?php echo urlencode($areaName); ?>&parameter=<?php echo urlencode($parameterName); ?>&quality=Implementation'" style="cursor: pointer;">
                    <td>Implementation</td>
                  </tr>
                  <tr onclick="location.href='documents.php?campus=<?php echo urlencode($campusName); ?>&college=<?php echo urlencode($collegeName); ?>&program=<?php echo urlencode($programName); ?>&area=<?php echo urlencode($areaName); ?>&parameter=<?php echo urlencode($parameterName); ?>&quality=Outcome/s'" style="cursor: pointer;">
                    <td>Outcome/s</td>
                  </tr>
                </tbody>
              </table>
