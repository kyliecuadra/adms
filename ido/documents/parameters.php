              ...
              <div class="d-flex justify-content-between mb-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb fs-4">
                    ...
                    <li class="breadcrumb-item">
                      <a href="#" onclick="window.history.back(); return false;"><?php echo $areaName; ?></a>
                    </li>
        ...
        $('#parameterTable').DataTable({
          ...
          columns: [{
            ...
            render: function(data, type, row) {
              return `
                    <div class="d-flex justify-content-between" onclick="location.href='quality.php?campus=<?php echo urlencode($campusName); ?>&college=<?php echo urlencode($collegeName); ?>&program=<?php echo urlencode($programName); ?>&area=<?php echo urlencode($areaName); ?>& parameter=${encodeURIComponent(row.parameter)}'" style="cursor: pointer;">
