...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar  ">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card px-4 py-4">
                            ...
                            <form action="" class="row mb-3">
                                <div class="col-3">
                                    <input class="form-control" list="parameters" name="parameter" id="parameter" placeholder="Parameter">

                                    <datalist id="parameters">
                                        <option value="Parameter 1">
                                        <option value="Parameter 2">
                                        <option value="Parameter 3">
                                        <option value="Parameter 4">
                                        <option value="Parameter 5">
                                    </datalist>
                                </div>
                                <div class="col-3">
                                    <input class="form-control" list="qualities" name="quality" id="quality" placeholder="Quality">

                                    <datalist id="qualities">
                                        <option value="Quality 1">
                                        <option value="Quality 2">
                                        <option value="Quality 3">
                                        <option value="Quality 4">
                                        <option value="Quality 5">
                                    </datalist>
                                </div>
                                <button class="btn col-2">Filter</button>
                            </form>
                            ...
                            <table id="campusTable" class="mr-2 table table-hover table-bordered table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="d-flex justify-content-between">Program 1
                                            <div>
                        ...
                        <tr>
                            <td class="d-flex justify-content-between">Program 2
                                <div>
                                    <a href=""><i class='text-danger fs-3 bx bx-trash'></i></a>
                            </td>
                    </div>
                    ...
                    <tr>
                        <td class="d-flex justify-content-between">Program 3
                            <div>
                                <a href=""><i class='text-danger fs-3 bx bx-trash'></i></a>
                        </td>
                </div>
                ...
                <tr>
                    <td class="d-flex justify-content-between">Program 4
                        <div>
                            <a href=""><i class='text-danger fs-3 bx bx-trash'></i></a>
                    </td>
            </div>
            ...
            <tr>
                <td class="d-flex justify-content-between">Program 5
                    <div>
                        <a href=""><i class='text-danger fs-3 bx bx-trash'></i></a>
                </td>
        </div>
        ...
        <tr>
            <td class="d-flex justify-content-between">Program 6
                <div>
                    <a href=""><i class='text-danger fs-3 bx bx-trash'></i></a>
            </td>
    </div>
