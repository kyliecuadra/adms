    ...
    <div class="layout-wrapper layout-content-navbar  ">
        <div class="layout-container">
            ...
            render: function(data, type, row) {
                return `
                    <div class="d-flex justify-content-between" onclick="location.href='programs.php?campus=${encodeURIComponent(row.campus)}&college=${encodeURIComponent(row.college)}'" style="cursor: pointer;">
