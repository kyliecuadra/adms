      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card px-4 py-4">
              <div>
                <button class="btn w-25 btn-danger float-end mb-4 mx-4 text-white" data-bs-toggle="modal" data-bs-target="#addDocumentModal">Add Document</button>
              </div>
              <table id="documents" class="mr-2 table table-hover table-bordered table-responsive">
                <thead>
                  <tr>
                    <th class="fw-bolder">ID</th>
                    <th class="fw-bolder">Area</th>
                    <th class="fw-bolder">Parameter</th>
                    <th class="fw-bolder">Quality</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Quality A</td>
                    <td>Document Name</td>
                    <td><button class="btn btn-danger text-white" data-bs-toggle="modal" data-bs-target="#updateDocumentModalupdateDocumentModal">Update Document</button></td>
                  </tr>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" id="inputGroupSelect04" aria-label="Example select with button addon">
                    <option selected>Select Collge</option>
                ...
                <div>
                  ...
                  <button type="button" class="btn btn-primary ms-3" data-bs-target="#fileUploadModal" data-bs-toggle="modal" data-bs-dismiss="modal">File Document</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="mb-3">
                  <label for="exampleDataList" class="form-label">Quality Measurement</label>
                  <input class="form-control" list="datalistOptions" id="exampleDataList"
                    placeholder="Type to search...">
                  <datalist id="datalistOptions">
                    <option value="Quality Measurement 1">
                    <option value="Quality Measurement 2">
                    <option value="Quality Measurement 3">
                    <option value="Quality Measurement 4">
                    <option value="Quality Measurement 5">
                  </datalist>
                </div>
                <div class="mb-3">
                  <label for="exampleDataList" class="form-label">List of Programs</label>
                  <div class="row">
                    <div class="col-6">
                      <p class="mt-2">Program 1</p>
                      <p>Program 2</p>
                      <p>Program 3</p>
                      <p>Program 4</p>
                      <p>Program 5</p>
              ...
              <div class="modal-footer">
                <button type="button" class="btn" data-bs-dismiss="modal"
                  style="color: #fff !important; background-color: #6c757d !important; border-color: #6c757d !important;">Close</button>
        ...
        <div class="modal fade" id="updateDocumentModal" tabindex="-1" aria-labelledby="updateDocumentModal" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="updateDocumentModalLabel">Update Document Name</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <div class="mb-3">
