...
<head>
    ...
    <title>System Configuration - <?php echo htmlspecialchars($campusName, ENT_QUOTES, 'UTF-8'); ?></title>
    ...
    <div class="layout-wrapper layout-content-navbar  ">
        <div class="layout-container">
            ...
            <div class="layout-page">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb fs-4">
                                        <li class="breadcrumb-item text-primary"><a href="campus.php">
                                                <?php echo $campusName; ?></a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Colleges</li>
                                    </ol>
                                </nav>
                                <button class="btn" data-bs-toggle="modal" data-bs-target="#addCollegeModal">Add
                                    College</button>
                            </div>
                ...
                <div class="modal fade" id="addCollegeModal" tabindex="-1" aria-labelledby="addCollegeLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="submitCollege" class="btn btn-primary">Add College</button>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- ADD COLLEGE MODAL END -->
                <!-- DELETE COLLEGE MODAL START -->
                <div class="modal fade" id="deleteCollegeModal" tabindex="-1" aria-labelledby="deleteCollegeModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="deleteCollegeModalLabel">Confirm Delete</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="deleteCollege" class="btn btn-danger">Delete</button>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- DELETE COLLEGE MODAL END -->
            </div>
            <!-- / Layout wrapper -->
            <!-- Core JS -->
            ...
            <script>
                ...
                $('#collegeTable').DataTable({
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                        <a href="#" class="text-danger fs-3 bx bx-trash" data-id="${row.college}" onclick="deleteCollege('${row.college}')"></a>
                        <a href="programs.php?campus=${encodeURIComponent(row.campus)}&college=${encodeURIComponent(row.college)}" class="text-success fs-3 bx bx-right-arrow-circle"></a>
                        </div>
                    </div>
                `;
                        }
