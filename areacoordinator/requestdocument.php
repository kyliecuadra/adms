    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <!-- REQUEST DOCUMENT FORM START -->
          <div class="container d-flex justify-content-center">
            <div class="col-lg-8"> <!-- Adjusted width -->
              <div class="card">
                <div class="card-body" style="padding: 15px;">
                  <h3 class="card-title text-dark">Request Document Form</h3>
                  <form>
                    <!-- Document Area -->
                    <div class="mb-3">
                    ...
                    <!-- Parameter -->
                    <div class="mb-3">
                      <label for="documentType" class="form-label">Parameter Area Selected</label>
                      <select class="form-select" id="documentType" required>
                        <option selected disabled>Select Parameter</option>
                        <option value="Area 1">Parameter 1</option>
                        <option value="Area 2">Parameter 2</option>
                        <option value="Area 3">Parameter 3</option>
                        <option value="Area 4">Parameter 4</option>
                      </select>
                    </div>                    
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="quality" placeholder="Quality (ex. 5.1/ 5.1.1)" required>
                    </div>

                    <!-- Benchmark Statement -->
                    <div class="mb-3">
                      <label for="benchmark" class="form-label">Benchmark Statement</label>
                      <textarea class="form-control" id="reason" rows="3" placeholder="Benchmark Statement" required></textarea>
                    </div>
