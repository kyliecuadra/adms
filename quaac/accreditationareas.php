  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card p-4">
      ...
      <div class="d-flex flex-wrap">
        ...
        <p class="w-100">Accreditation Areas</p>
      </div>
      <table id="departments" class="table table-hover table-bordered table-responsive">
        <thead>
          <tr>
            <th class="text-center p-3" style="width: 250px;"><strong>Areas</strong></th> <!-- Set custom width -->
            <th class="text-center p-3"><strong>Actions</strong></th>
          </tr>
        </thead>
        <tbody id="faculty-table-body">
          <tr>
            <td class="text-center p-2" style="width: 250px;">Area 1</td> <!-- Set custom width -->
            <td class="text-center d-flex justify-content-center align-items-center p-2">
              <a class="btn btn-success mx-2" href="#" role="button">System</a>
              <a class="btn btn-success mx-2" href="#" role="button">Implementation</a>
              <a class="btn btn-success mx-2" href="#" role="button">Output</a>
            </td>
          </tr>
          <tr>
            <td class="text-center p-2" style="width: 250px;">Area 2</td>
            <td class="text-center d-flex justify-content-center align-items-center p-2">
              <a class="btn btn-success mx-2" href="#" role="button">System</a>
              <a class="btn btn-success mx-2" href="#" role="button">Implementation</a>
              <a class="btn btn-success mx-2" href="#" role="button">Output</a>
          ...
          <tr>
            <td class="text-center p-2" style="width: 250px;">Area 3</td>
            <td class="text-center d-flex justify-content-center align-items-center p-2">
              <a class="btn btn-success mx-2" href="#" role="button">System</a>
              <a class="btn btn-success mx-2" href="#" role="button">Implementation</a>
              <a class="btn btn-success mx-2" href="#" role="button">Output</a>
          ...
          <tr>
            <td class="text-center p-2" style="width: 250px;">Area 4</td>
            <td class="text-center d-flex justify-content-center align-items-center p-2">
              <a class="btn btn-success mx-2" href="#" role="button">System</a>
              <a class="btn btn-success mx-2" href="#" role="button">Implementation</a>
              <a class="btn btn-success mx-2" href="#" role="button">Output</a>
          ...
          <tr>
            <td class="text-center p-2" style="width: 250px;">Area 5</td>
            <td class="text-center d-flex justify-content-center align-items-center p-2">
              <a class="btn btn-success mx-2" href="#" role="button">System</a>
              <a class="btn btn-success mx-2" href="#" role="button">Implementation</a>
              <a class="btn btn-success mx-2" href="#" role="button">Output</a>
